...
public class TestSign {
	...
	public static JSONObject testSignPayment(){
		JSONObject obj = new JSONObject();
		JSONObject tx_json = new JSONObject();
		tx_json.put("Account", "zHb9CJAWyB4zj91VRWn96DkukG4bwdtyTh");
		tx_json.put("Amount", "10000000000"); // 需要加6个0 ,单位是drop
		tx_json.put("Destination", "zMX4gXEtRc7ET4V3bywBy88TuMGPvjyQdn");
		tx_json.put("TransactionType", "Payment");
		tx_json.put("Sequence", 13);
